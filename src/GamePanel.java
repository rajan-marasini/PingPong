...
public class GamePanel extends JPanel implements Runnable {
    ...
    static final int GAME_HEIGHT = (int) ((float) GAME_WIDTH * 0.555555);
    ...
    public void newPaddles() {
        ...
        paddle2 = new Paddle((GAME_WIDTH - PADDLE_WIDHT), (GAME_HEIGHT / 2) - (PADDLE_HEIGHT / 2), PADDLE_WIDHT,
                PADDLE_HEIGHT, 2);
    }
    ...
    public void checkCollision() {
        ...
        if (ball.intersects(paddle1)) {
            ...
            ball.xVelocity++;// optimal for more difficulty

            if (ball.yVelocity > 0)
                ball.yVelocity++;// optimal for more difficulty
            else
                ball.yVelocity--;// optimal for more difficulty
